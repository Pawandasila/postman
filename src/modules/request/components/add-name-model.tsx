      ...
      <div className="space-y-5">
        ...
        <div className="flex items-start gap-2 p-3 bg-muted/30 rounded-lg border border-border">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            descriptive names that clearly indicate what the request does. Click
            the sparkle icon to generate AI-powered name suggestions based on
            your request URL and method.
          </p>
        </div>
      </div>
    </Modal>
