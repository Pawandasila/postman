...
import { Folder, Search, FolderOpen, ChevronRight, X } from "lucide-react";
...
const SaveRequestToCollectionModal = ({
  ...
  useEffect(() => {
    ...
    // If a collectionId is provided, we don't want to auto-select the first one
  ...
  > = {
    [REST_METHOD.GET]: {
      variant: "outline",
      className:
        "bg-green-500/10 text-green-600 border-green-500/30 hover:bg-green-500/20 dark:text-green-400 dark:border-green-400/30",
    },
    [REST_METHOD.POST]: {
      variant: "outline",
      className:
        "bg-blue-500/10 text-blue-600 border-blue-500/30 hover:bg-blue-500/20 dark:text-blue-400 dark:border-green-400/30",
    },
    [REST_METHOD.PUT]: {
      variant: "outline",
      className:
        "bg-yellow-500/10 text-yellow-700 border-yellow-500/30 hover:bg-yellow-500/20 dark:text-yellow-400 dark:border-yellow-400/30",
    },
    [REST_METHOD.DELETE]: {
      variant: "destructive",
      className:
        "bg-red-500/10 text-red-600 border-red-500/30 hover:bg-red-500/20 dark:text-red-400 dark:border-yellow-400/30",
    },
    [REST_METHOD.PATCH]: {
      variant: "outline",
      className:
        "bg-orange-500/10 text-orange-600 border-orange-500/30 hover:bg-orange-500/20 dark:text-orange-400 dark:border-yellow-400/30",
    },
  };
  ...
  const selectedCollection = collectionsList.find(
